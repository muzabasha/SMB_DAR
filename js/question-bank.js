const questionBankContent = {
    "u1": [
        {
            id: "u1-q1",
            question: "Evaluate the trade-offs between 'Descriptive' and 'Predictive' analytics for a startup with limited historical data. Which one should be the priority in the first 6 months, and why? [10 Marks]",
        ...
        {
            id: "u1-q2",
            question: "A smart city project generates 1 Terabyte of sensor data every hour. Analyze this scenario using the 5 V's of Big Data. Which 'V' poses the greatest challenge for real-time traffic management? [10 Marks]",
        ...
        {
            id: "u1-q3",
            question: "Compare Structured, Semi-structured, and Unstructured data. In a modern recruitment platform (with Resumes, LinkedIn profile links, and Interview videos), how would you categorize these and what specific analytics tool would you use for each? [10 Marks]",
        ...
        {
            id: "u1-q4",
            question: "Criticize the statement: 'Data Analytics is just a modern name for Statistics.' Support your argument with three distinct differences in goals and methodologies. [10 Marks]",
        ...
        {
            id: "u1-q5",
            question: "In the context of 'Precision Healthcare', how does the 'Variety' characteristic of Big Data aid in personalized medicine? Provide an illustration. [10 Marks]",
        ...
        {
            id: "u1-q6",
            question: "Analyze the 'Data Analytics Lifecycle'. Why is 'Data Preparation' considered the most time-consuming phase (60-80%)? What happens if you skip it and move directly to Modeling? [10 Marks]",
        ...
        {
            id: "u1-q7",
            question: "Design a data-driven strategy for an E-commerce company to reduce 'Shopping Cart Abandonment' using Diagnostic Analytics. What variables would you investigate? [10 Marks]",
        ...
        {
            id: "u1-q8",
            question: "Evaluate the role of 'Veracity' in social media sentiment analysis. How do 'sarcasm' and 'slang' affect the reliability of Big Data insights? [10 Marks]",
        ...
        {
            id: "u1-q9",
            question: "Compare 'Batch Processing' vs. 'Stream Processing'. For a 'Bank Fraud Alert' system, which one is non-negotiable? Contrast this with a 'Monthly Bank Statement' generation. [10 Marks]",
        ...
        {
            id: "u1-q10",
            question: "Synthesize the concept of 'Data Monetization'. How can a Telecom company use its data (call patterns, location) to create a new revenue stream without selling private individual identities? [10 Marks]",
    ...
    "u2": [
        {
            id: "u2-q1",
            question: "You have a vector with 1 million integers. Compare the efficiency of a `for` loop vs. `vectorized operations` in R. Why is R often criticized for being 'slow' in loops, and how do we resolve this? [10 Marks]",
        ...
        {
            id: "u2-q2",
            question: "Analyze the 'Data Frame' vs 'Matrix' in R. If you are building a dataset with 'Age', 'Name', and 'Salary', why is a Matrix a catastrophic choice? [10 Marks]",
        ...
        {
            id: "u2-q3",
            question: "Evaluate the use of 'Factors' in R. How does treating a 'Blood Group' column as a factor instead of a character string save memory and improve modeling? [10 Marks]",
        ...
        {
            id: "u2-q4",
            question: "A script is failing with 'unexpected NA values'. Distinguish between `is.na()` and `!complete.cases()`. Which one is better for cleaning a whole data frame in one line? [10 Marks]",
        ...
        {
            id: "u2-q5",
            question: "A researcher wants to process 500 CSV files. Design a workflow using R's `list.files()`, `lapply()`, and `do.call(rbind, ...)`. What is the role of each function in this 'Industrial' data ingestion? [10 Marks]",
        ...
        {
            id: "u2-q6",
            question: "Contrast 'Lexical Scoping' in R functions. If a variable is defined both inside a function and in the Global Environment, which one does R use, and how can this lead to 'Silent Bugs'? [10 Marks]",
        ...
        {
            id: "u2-q7",
            question: "Assess the 'Lazy Evaluation' mechanism in R functions. How does it allow us to write code that 'doesn't crash unless needed'? [10 Marks]",
        ...
        {
            id: "u2-q8",
            question: "In string manipulation, analyze the difference between `grep()` and `grepl()`. Build a scenario where using the wrong one would break a logical `if` statement. [10 Marks]",
        ...
        {
            id: "u2-q9",
            question: "Design a custom R function to calculate 'BMI' that handles 'NA' inputs gracefully and provides a warning if the weight is less than zero. [10 Marks]",
        ...
        {
            id: "u2-q10",
            question: "Synthesize the concept of 'Recycling' in R vector math. If you add a vector of length 2 to a vector of length 6, what happens? How can this lead to misleading results in payroll data? [10 Marks]",
    ...
    "u3": [
        {
            id: "u3-q1",
            question: "You have a dataset of 1 million transactions. A scatter plot results in a 'Solid Black Blob'. Propose and evaluate three advanced visualization strategies to reveal hidden density patterns. Which one is best for discovering 'local clusters' vs. 'global trends'? [10 Marks]",
        ...
        {
            id: "u3-q2",
            question: "A company wants to visualize 'Revenue by Region' and 'Profitability' simultaneously for 50 cities. Evaluate the choice of a 'Choropleth Map' vs. a 'Faceted Bar Chart'. Which leads to more accurate decision making, and why? [10 Marks]",
        ...
        {
            id: "u3-q3",
            question: "Distinguish between 'Sequential', 'Diverging', and 'Qualitative' color scales. In a dashboard showing 'Temperature Anomalies' (-10 to +10 degrees), which scale is non-negotiable? Provide a psychological justification. [10 Marks]",
        ...
        {
            id: "u3-q4",
            question: "Apply the 'Grammar of Graphics' to explain how a Bubble Chart is technically a 'Scatter Plot with a Size Mapping'. How does adding this third dimension (Size) often lead to 'Visual Deception'? [10 Marks]",
        ...
        {
            id: "u3-q5",
            question: "Analyze the 'Lie Factor' in an Infographic where a 2D icon of a 'Shopping Bag' is scaled up to represent a 20% increase in sales. Calculate the potential 'Visual Inflation' if both height and width are scaled by 1.2x. [10 Marks]",
        ...
        {
            id: "u3-q6",
            question: "Evaluate the use of 'Faceting vs. Grouping' in a dataset with 4 categories and 1000 points. If the categories overlap significantly, which technique produces less 'Visual Noise'? [10 Marks]",
        ...
        {
            id: "u3-q7",
            question: "In exploratory data analysis (EDA), explain why we should use a 'Log Scale' for the X-axis when visualizing 'Personal Income' across a whole country. What happens to the 'Tail' in a linear vs. log histogram? [10 Marks]",
        ...
        {
            id: "u3-q8",
            question: "Design a visualization for a 'Network Security' dashboard showing 1,000 IP addresses and their connection counts. Propose a 'Non-traditional' plot (e.g., Chord Diagram or Treemap) and justify why it's better than a sorted Bar Chart. [10 Marks]",
        ...
        {
            id: "u3-q9",
            question: "Compare 'Boxplots' with 'Violin Plots'. If your underlying data is 'Bimodal' (has two peaks, like heights of mixed male/female groups), which plot will hide this critical insight? [10 Marks]",
        ...
        {
            id: "u3-q10",
            question: "Critical Analysis: A dashboard shows a 'Gauge Chart' (Speedometer style) for quarterly targets. Why do visualization experts like Stephen Few consider Gauge charts to be 'Low Information Density' and 'Space Wasting'? [10 Marks]",
    ...
    "u4": [
        {
            id: "u4-q1",
            question: "A Linear Regression model for 'Salary prediction' has an $R^2$ of 0.95. However, the 'Residual Plot' shows a clear U-shape. Evaluate the validity of this model for making business predictions. What is the 'Missing Link'? [10 Marks]",
        ...
        {
            id: "u4-q2",
            question: "You are training a Random Forest with 1,000 trees. The training accuracy is 100%, but the 'Out-of-Bag' (OOB) error is 40%. Analyze this discrepancy. Is the model useful for 'Future Data'? [10 Marks]",
        ...
        {
            id: "u4-q3",
            question: "Compare 'Standardization' (Z-score) vs 'Normalization' (Min-Max). For a 'KNN Clustering' algorithm where 'Annual Income' (thousands) and 'Age' (units) are features, which scaling is essential and why? [10 Marks]",
        ...
        {
            id: "u4-q4",
            question: "A medical AI for 'Cancer Detection' has 99.9% accuracy. However, in a population of 10,000 where only 10 people have cancer, the model predicts 'Healthy' for everyone. Evaluate the 'Accuracy Paradox'. What metric should the hospital use instead? [10 Marks]",
        ...
        {
            id: "u4-q5",
            question: "Apply 'Hypothesis Testing' (t-test) to a marketing campaign. If the p-value is 0.06 and the threshold ($\alpha$) is 0.05, should the company invest $1M in the new strategy? Analyze the risk of 'Type II Error' here. [10 Marks]",
        ...
        {
            id: "u4-q6",
            question: "Differentiate between 'Logistic Regression' and 'Linear Regression'. Build a mathematical argument for why Linear Regression is physically impossible for predicting 'Pass/Fail' outcomes. [10 Marks]",
        ...
        {
            id: "u4-q7",
            question: "Analyze 'K-Fold Cross Validation'. If $K=1$, why does the concept break down? If $K=N$ (Leave-one-out), what is the computational cost for a dataset with 1 million rows? [10 Marks]",
        ...
        {
            id: "u4-q8",
            question: "In Decision Trees, evaluate the 'Greedy Search' strategy. How does it lead to a 'Sub-optimal' global tree? What modern technique (Ensemble) fixes this? [10 Marks]",
        ...
        {
            id: "u4-q9",
            question: "Contrast 'Correlation' vs 'Mutual Information' (MI). If a relationship is perfectly circular (e.g., $X^2 + Y^2 = 1$), why will Correlation be 0 but MI be high? [10 Marks]",
        ...
        {
            id: "u4-q10",
            question: "Synthesize the 'Curse of Dimensionality'. Why does adding 100 more features (variables) to a model with only 50 rows of data usually 'Destroy' the model's accuracy? [10 Marks]",
...
window.questionBankContent = questionBankContent;
